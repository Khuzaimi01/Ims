...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
    $stmt = $conn->prepare("INSERT INTO barang_pejabat_bf (product_name, descriptions, much, code, status, quantity, created_at, manual_date, updated_at, image_path, loc_code, loc_asset) VALUES (?, ?, ?, ?, ?, ?, NOW(), ?, NOW(), ?, ?, ?)");
...
$stmt = $conn->prepare("SELECT * FROM barang_pejabat_bf ORDER BY created_at DESC");
$stmt->execute();
                    ...
                    <!-- ... (Your existing PHP and HTML code) ... -->
                        ...
                        <div class="section_box">
                            <div class="section_header">
                                <div class="dashboard_header">Kawasan Beaufort</div>
                                <i class="fa-solid fa-plus"></i> Peralatan Pejabat
                            </div>
                            <form id="addProductForm" method="POST">
                             ...
                             <div class="form-group">
                                    ...
                                    <select id="loc_code" name="loc_code" class="input-field">
                                        <option value="15020">15020</option>
                                </div>
                            <div class="form-group">
                    ...
                    <div class="column column-6">
                        <div class="section_box">
                            <div class="section_header">
                                ...
                                <p><a href="export-excel-bf.php">Export to Excel</a></p>
        ...
        <table class="product_table">
            <thead>
                <tr>
                    ...
                    <th>Quantity</th>
                    <th>Brand</th>
                    <th>Asset Code</th> <!-- Add this line -->
                    <th>Date of Puchase</th>
                    <th>Price(RM)</th>
           ...
           <tbody>
                <?php foreach ($products as $index => $product) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="barang-edit-bf.php?id=<?= $product['id'] ?>">Edit</a> |
                            <a href="barang-delete-bf.php?id=<?= $product['id'] ?>" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>

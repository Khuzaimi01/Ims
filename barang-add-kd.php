...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
    $stmt = $conn->prepare("INSERT INTO barang_pejabat_kd (product_name, descriptions, much, code, status, quantity, created_at, manual_date, updated_at, image_path, loc_code, loc_asset) VALUES (?, ?, ?, ?, ?, ?, NOW(), ?, NOW(), ?, ?, ?)");
...
$stmt = $conn->prepare("SELECT * FROM barang_pejabat_kd ORDER BY created_at DESC");
$stmt->execute();
                    ...
                    <!-- ... (Your existing PHP and HTML code) ... -->
                        ...
                        <div class="section_box">
                            <div class="section_header">
                                <div class="dashboard_header">Kawasan Kudat</div>
                    ...
                    <div class="column column-6">
                        <div class="section_box">
                            <div class="section_header">
                                ...
                                <p><a href="export-excel-kd.php">Export to Excel</a></p>
           ...
           <tbody>
                <?php foreach ($products as $index => $product) { ?>
                    <tr>
                        ...
                        <td>
                            <a href="barang-edit-kd.php?id=<?= $product['id'] ?>">Edit</a> |
                            <a href="barang-delete-kd.php?id=<?= $product['id'] ?>" onclick="return confirm('Are you sure you want to delete this product?')">Delete</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
